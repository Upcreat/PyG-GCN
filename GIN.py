...
class GCN(torch.nn.Module):
    def __init__(self, num_node_features, num_classes):
        ...
        # self.conv1 = GINConv(num_node_features, 32)
        self.conv1 = GINConv(Seq(Lin(num_node_features, 32), ReLU(), Lin(32, 32)))

        # self.conv2 = GINConv(32, num_classes)
        self.conv2 = GINConv(Seq(Lin(32, 32), ReLU(), Lin(32, num_classes)))
